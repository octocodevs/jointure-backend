...
class ProposalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $proposal->image = "http://localhost:8000/img/vegan-food-fair.jpg";
        // $proposal->category_id = ;
        ...
        $proposal->brand = 'PintArte';
        $proposal->image = "http://localhost:8000/img/bright-makeup.jpg";
        // $proposal->category_id = ;
        ...
        $proposal2->cost = null;
        $proposal2->objectives = 'Crear un vinculo de marcas urbanas de Barcelona, promover MAKE IT UP y dar más visibildad a marcas locales más pequeñas con productos creado en colaboración';
        ...
        $proposal->image = "http://localhost:8000/knitting.jpg";
        ...
        $proposal->image = "http://localhost:8000/img/fruut-bars.jpg";
        ...
        $proposal->brand = 'Zzapas';
        $proposal->image = "http://localhost:8000/img/sports-shoes.jpg";
        ...
        $proposal->brand = 'Cakery';
        $proposal->image = "http://localhost:8000/img/cakery-donuts.jpg";
        ...
        $proposal6->cost = null;
        $proposal6->objectives = 'Celebrar y promover la apertura de Cakery, además de ofrecer nuestros clientes una tarde de lujo. Idealmente, el evento seria a la tarde/noche del día 14 de septiembre en la pasteleria y su terraza';
        $proposal6->ideal_collaborators = 'Marcas de lujo, champán, belleza, esteticistas, cosmetólogas';
        $proposal6->proposal = null;
        ...
        $proposal7->user_id = '1';
        $proposal->brand = 'TechTalent';
        $proposal->image = "http://localhost:8000/img/woman-tech.jpg";
        ...
        $proposal7->cost = null;
        $proposal7->objectives = null;
        $proposal7->ideal_collaborators = 'Marcas, empresas y agencias del mundo tecnológico con interés en contratar madres';
        $proposal7->proposal = null;
